...
src/ap/thread/boot/boot.o: C:/Users/jhcho/Desktop/GITHUB/STM32G4_FDCAN/firmware/stm32g4-uds/src/ap/thread/boot/boot.c src/ap/thread/boot/subdir.mk
...
clean: clean-src-2f-ap-2f-thread-2f-boot

clean-src-2f-ap-2f-thread-2f-boot:
	-$(RM) ./src/ap/thread/boot/boot.cyclo ./src/ap/thread/boot/boot.d ./src/ap/thread/boot/boot.o ./src/ap/thread/boot/boot.su

.PHONY: clean-src-2f-ap-2f-thread-2f-boot
